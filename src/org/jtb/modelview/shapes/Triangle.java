package org.jtb.modelview.shapes;

import static org.jtb.modelview.d3.Vertex.X;
import static org.jtb.modelview.d3.Vertex.Y;
import static org.jtb.modelview.d3.Vertex.Z;

import java.util.List;

import org.jtb.modelview.d3.Color;
...
public class Triangle {
	...
	public Triangle(Color color, Vertex v1, Vertex v2, Vertex v3, Vertex normal) {
		this(color, v1, v2, v3);
		this.normal = normal;
	}
	...
	public static float boundingRadius(List<Triangle> tris, Vertex mid) {
		float radius = 0f;
		float dist;
		for (Triangle t : tris) {
